...
export async function launchNewTerminal(
	...
	if (folderPath) {
		...
		if (!workspaceFolder) {
			console.warn(`[Pixel Agents] Security: Requested folderPath "${folderPath}" is outside the workspace. Falling back.`);
			vscode.window.showWarningMessage(`Pixel Agents: Requested folder is outside the workspace. Using default instead.`);
