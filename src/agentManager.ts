...
export async function launchNewTerminal(
	...
	// Security: Validate that the provided folderPath is within the workspace
	let validatedPath: string | undefined = undefined;
	if (folderPath) {
	...
	const cwd = validatedPath || folders?.[0]?.uri.fsPath;
