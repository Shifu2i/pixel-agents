...
export async function launchNewTerminal(
	...
	if (folderPath) {
		...
		if (!workspaceFolder) {
			console.warn(`[Pixel Agents] Security: Requested folderPath "${folderPath}" is not in workspace. Falling back to default.`);
			vscode.window.showWarningMessage('Pixel Agents: Requested folder is not in workspace. Using default folder.');
